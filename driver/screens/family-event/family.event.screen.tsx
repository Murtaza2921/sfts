...
export default function FamilyEvents() {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        const response = await axios.get(`${process.env.EXPO_PUBLIC_SERVER_URI}/driver/get-events`);
        
        // Axios automatically parses the response as JSON, so no need to call `.json()`
