...
const ForgotPasswordScreen = () => {
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.EXPO_PUBLIC_SERVER_URI}/user/forget-password`, {
                 contact,
               });
      ...
      if (response.data.success) {
        ...
        const smsResponse = await axios.post(`${process.env.EXPO_PUBLIC_SERVER_URI}/user/sendSms`, {
          recipient: contact,
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.EXPO_PUBLIC_SERVER_URI}/user/resetPassword`, {
        contact,
        otp,
        newPassword,
      });
